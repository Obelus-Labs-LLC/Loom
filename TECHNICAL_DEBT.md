...
| TD-020 | loom-security no_std HashMap | L15 | Post-L23 | Low | **Excluded from build** - Using `alloc::collections::HashMap` which doesn't exist; should use `hashbrown::HashMap`. |
| TD-021 | loom-content type annotations | L6 | Post-L23 | Low | **Excluded from build** - Missing explicit type annotations in closures. |
